...
from models.snunet import SNUNet_ECAM, init_weights_xavier, count_parameters
from utils.dataset import get_loaders, LEVIRDataset
...
def main():
    ...
    logging.basicConfig(level=logging.INFO,
                        ...
                        handlers=[
                            logging.FileHandler('train_history.log'),
